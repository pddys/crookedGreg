  ...
  <section class="c-section c-section--menu c-menu" ref="main" id="menu">
    ...
    <div class="c-marquee">
      <div class="c-marquee__inner forward">
        <span>Menu</span><span>Menu</span><span>Menu</span><span>Menu</span
        ><span>Menu</span><span>Menu</span><span>Menu</span><span>Menu</span
    ...
    ScrollTrigger.matchMedia({
      "(min-width: 769px)": function () {
        menuItems.forEach((item) => {
          ...
          let menuIngredients = item.querySelectorAll("li");
          ...
          gsap.set(menuIngredients, {
            opacity: 0,
            scale: 0.875,
            y: 50,
          });
          gsap.to(menuIngredients, {
            opacity: 1,
            scale: 1,
            y: 0,
            stagger: 0.5,
